...
class _FaqPageState extends State<FaqPage> {
  List<Panel> panels = [
    Panel(
        ...
        'De manera predeterminada, la última dirección de envío utilizada se guardará en su cuenta de la Tienda de muestras. Cuando esté pagando su pedido, se mostrará la dirección de envío predeterminada y tiene la opción de modificarla si es necesario.',
        false),
    Panel(
